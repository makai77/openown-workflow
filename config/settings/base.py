...
MIGRATION_MODULES = {"sites": "openown.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "openown.users.context_processors.allauth_settings",
            ],
        },
    },
]
...
ADMINS = ['"Makai Kahilu" <makaikahilu4@gmail.com>']
...
# https://docs.allauth.org/en/latest/account/configuration.html
ACCOUNT_ADAPTER = "openown.users.adapters.AccountAdapter"
# https://docs.allauth.org/en/latest/account/forms.html
ACCOUNT_FORMS = {"signup": "openown.users.forms.UserSignupForm"}
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_ADAPTER = "openown.users.adapters.SocialAccountAdapter"
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_FORMS = {"signup": "openown.users.forms.UserSocialSignupForm"}
...
REST_FRAMEWORK = {
    ...
    "PAGE_SIZE": 20,
    "EXCEPTION_HANDLER": "openown.applications.exception_handler.api_exception_handler",
}
